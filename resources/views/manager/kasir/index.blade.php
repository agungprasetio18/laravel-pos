...
@section('title', 'Manager - Tambah Kasir')

@section('active-manager-kasir', 'active')

@section('content')

<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">User Baru Untuk Kasir</h1>
    <button onclick="document.location.href='{{route('manager.kasir.create')}}'"
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right mr-4 shadow animated--fade-in"
                                            ...
                                            <a href="#hapus" type="button" class="dropdown-item" data-toggle="modal"
                                                data-target="#modalHapus" data-id="{{$kasir->id}}">
                                                Hapus
                                            </a>
                                        </div>
                                    </div>
...
<div class="modal fade" id="modalHapus" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('manager.kasir.destroy', $kasir->id) }}" method="POST">
                @csrf
                @method('DELETE')
